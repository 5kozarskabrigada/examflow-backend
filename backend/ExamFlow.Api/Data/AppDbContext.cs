...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MockExam>(entity =>
        {
            ...
            entity.Property(x => x.LockdownPolicy).HasMaxLength(32).HasDefaultValue("standard");
        ...
        {
            entity.Property(x => x.ModuleType).HasMaxLength(32).IsRequired();
            entity.Property(x => x.Title).HasMaxLength(250).IsRequired();
            entity.Property(x => x.Content);
            entity.Property(x => x.AudioUrl).HasMaxLength(500);
            entity.HasIndex(x => x.ExamId);
            entity.HasIndex(x => x.ModuleType);
        });
    }
}
